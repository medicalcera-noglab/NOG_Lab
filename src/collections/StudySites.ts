...
import { revalidateStudySites, revalidateStudySitesOnDelete } from '../hooks/revalidateCache'
...
export const StudySites: CollectionConfig = {
  ...
  hooks: {
    ...
    afterDelete: [revalidateStudySitesOnDelete, makeAuditDeleteHook('study_sites')],
  },
  fields: [
    {
      name: 'name',
